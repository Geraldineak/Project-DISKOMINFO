...
<div class="container container-body-index">
    ...
    <div class="col-md-12 form-kelas">
        ...
        <form action="{{ route('departemen.update', $datas) }}" method="post">
            {{ csrf_field() }}
            {{ method_field('PUT') }}
            <div class="form-group">
                <label for="">Nama Departement</label>
                <input type="text" name="nama_departemen" id="nama_departemen" value="{{ $datas->nama_departemen }}" class="form-control" require>
            </div>
            <div class="form-group">
